      ...
      <div>
        ...
        <div>
            ...
            >
              ...
              >
                <el-input
                  ...
                  disabled
                  style="width: 80%"
                  >{{ this.room.dormBuildId }}</el-input
                >
              </el-form-item>
              <el-form-item
                label="房间号"
              ...
              >
                <el-input
                  ...
                  disabled
                  style="width: 80%"
                  >{{ this.room.dormRoomId }}</el-input
                >
              </el-form-item>
              <el-form-item label="申请人" prop="repairer">
                <el-input v-model="form.repairer" disabled style="width: 80%">{{
                  this.name
                }}</el-input>
              </el-form-item>
              <el-form-item
          ...
          <el-dialog v-model="detailDialog" title="详情" width="30%">
            ...
            <template #footer>
              <span class="dialog-footer">
                <el-button type="primary" @click="closeDetails"
                  >确 定</el-button
                >
              </span>
            </template>
